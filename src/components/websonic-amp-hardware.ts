  ...
  render() {
    return html`
        ...
        ${this.isAuthenticated ? html`
          ...
          >
            <h4 class="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] uppercase font-bold tracking-widest text-[#d4af37] whitespace-nowrap">Queue</h4>
          ...
          >
            <h4 class="absolute -top-7 left-1/2 -translate-x-1/2 text-[10px] uppercase font-bold tracking-widest text-[#d4af37] whitespace-nowrap text-center">Library</h4>
